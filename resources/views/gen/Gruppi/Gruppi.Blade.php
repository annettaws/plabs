...
@section('content')
<script src=" <% asset('app/controllers/gen/Gruppi/GruppiControllers.js')%>" type='text/javascript'></script>
    <div id="contenitore" class="container" ng-controller="GruppiControllers" style="margin-top:20px">
		...
		<div class="row">
					...
					<div class="col-md-12 ">
			            <div class="panel panel-default">
                            ...
                            <thead>
                                <tr>
                                  <th>ID</th><th>Nome</th><th>Descrizione</th>  <th></th>

                                </tr>
                            </thead>
                            <tbody>
                                <tr  dir-paginate="c in lista | itemsPerPage: 5 | filter:search" pagination-id="cust1" >
                                    <td >   {{c.ID }}</td><td >   {{c.Nome }}</td><td >   {{c.Descrizione }}</td> <td> <button type="button" ng-click="seleziona(c)" class="btn btn-default"> <span class="glyphicon glyphicon-pencil " aria-hidden="true"></span></button></td>
