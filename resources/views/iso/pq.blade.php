@extends('app')
@section('title','| Piani di qualità')
@section('content')
<script src=" <% asset('app/controllers/amministrazione/listiniControllers.js')%>" type='text/javascript'></script>
<div class="container" ng-controller="listiniControllers" style="margin-top:20px">
